...
public class RequisitoDAO extends ConnectionFactory {
	...
	public void insert(Requisito requisito) {
		...
		try {
			...
			this.stmtp.setString(2, requisito.getMemoriaram());
			this.stmtp.setString(3, requisito.getHd());
			this.stmtp.setString(4, requisito.getVideo());
	...
	public void update(Requisito requisito) {
		...
		try {
			...
			this.stmtp.setString(3, requisito.getHd());
			this.stmtp.setString(4, requisito.getVideo());
			this.stmtp.setInt(5, requisito.getId());
			this.stmtp.executeUpdate();
		} catch (SQLException e) {
